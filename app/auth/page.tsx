...
export default function AuthPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      <Header />
      <div className="flex-1 bg-blue-500 flex flex-col items-center justify-center p-4">
        <div className="text-white mb-8 flex items-center">
          ...
          <h1 className="text-2xl font-semibold">ODLMS</h1>
        </div>
        ...
        <div className="w-full max-w-md perspective">
          <AnimatePresence mode="wait" initial={false}>
            {isLogin ? (
              ...
              >
                <h2 className="text-xl text-gray-600 text-center mb-8">Sign In With Your ODLMS Account</h2>
